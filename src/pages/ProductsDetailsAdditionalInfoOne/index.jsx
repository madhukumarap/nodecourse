...
const ProductsDetailsAdditionalInfoOnePage = () => {
  return (
    <>
          ...
          <div className="flex flex-col gap-[33px] items-center justify-start mt-[79px] w-full">
            <div className="flex flex-col items-start justify-start w-auto md:w-full">
              <div className="bg-gray-100_01 flex md:flex-col flex-row md:gap-5 items-center justify-start p-[38px] sm:px-5 w-full">
                <div className="flex sm:flex-1 flex-col gap-1 h-[83px] md:h-auto items-start justify-start md:ml-[0] ml-[261px] md:px-5 w-auto sm:w-full">
                  <Text
...
export default ProductsDetailsAdditionalInfoOnePage;
