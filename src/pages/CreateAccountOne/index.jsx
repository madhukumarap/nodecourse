...
const CreateAccountOnePage = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto pb-[35px] w-full">
        ...
        />
        <div className="bg-white-A700 border border-gray-100 border-solid flex flex-col gap-5 items-center justify-center mt-20 pb-8 pt-6 md:px-5 px-6 rounded-lg shadow-bs17 w-auto sm:w-full">
          <Text
        ...
        <Footer1 className="flex items-center justify-center mt-[52px] md:px-5 w-full" />
      </div>
    </>
  );
};

export default CreateAccountOnePage;
