...
const ErrorPageOnePage = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto pb-[42px] w-full">
        ...
        <div className="flex flex-col items-center justify-start mt-20 md:px-5 w-[32%] md:w-full">
          ...
          />
          <Text
            className="mt-[29px] sm:text-4xl md:text-[38px] text-[40px] text-black-900 text-center"
          ...
          <div className="flex flex-col gap-9 items-center justify-center w-full">
            <div className="flex flex-col items-start justify-start w-auto md:w-full">
              <div className="bg-gray-100_01 flex md:flex-col flex-row md:gap-5 items-center justify-end p-[38px] sm:px-5 w-full">
                ...
                <div className="flex sm:flex-col flex-row gap-2 items-start justify-start ml-10 md:ml-[0] mr-[258px] w-auto">
                  <Button
            ...
            <div className="flex flex-col font-quicksand gap-[35px] items-center justify-start w-full">
              ...
              <div className="h-[62px] sm:h-[76px] relative w-full">
                ...
                <div className="absolute flex sm:flex-col flex-row md:gap-10 md:h-auto h-full inset-[0] items-center justify-between m-auto max-w-[1917px] w-full">
                  <Text
...
export default ErrorPageOnePage;
