...
const AboutPage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto pb-[41px] w-full">
        ...
        <div className="flex flex-col items-center justify-start max-w-[1364px] mt-20 mx-auto md:px-5 w-full">
          <div className="flex md:flex-col flex-row md:gap-[41px] items-center justify-between w-full">
            <div className="flex flex-col gap-8 items-center justify-start">
              <Text
                className="leading-[120.00%] md:text-5xl sm:text-[42px] text-[56px] text-black-900 w-full"
                size="txtPoppinsSemiBold56Black900"
              >
        ...
        <div className="bg-gradient4  h-[685px] md:h-[765px] mt-20 pr-[300px] md:px-5 relative shadow-bs7 w-full">
        ...
        <Footer1 className="flex items-center justify-center mt-[158px] md:px-5 w-full" />
      </div>
    </>
  );
};
